      ...
      <div className="container bg-white rounded-xl py-5">
        <table>
          ...
          <tbody>
            {categories && categories.map((item, index) => (
              <tr className='flex md:items-center gap-8' key={item.id}>
        ...
        <form onSubmit={createCategory} className='mt-10 flex-col items-center'>
          <div className='flex flex-col'>
            <label className='text-sm'>Create and Edit (English)</label>
          ...
          <div className='flex flex-col'>
            <label className='text-sm'>Create and Edit (Russian)</label>
          ...
          <div className='flex flex-row items-center'>
            <label htmlFor="fileInput" className='text-sm mr-2'>Image:</label>
            <input className='text-sm' id="fileInput" type="file" onChange={(e) => setData({ ...data, image_src: e.target.files[0] })} />
            <button className='text-sm border-current border-2 p-2 ml-2' type='submit' onClick={notify}>Create</button>
          </div>
        </form>
      </div>
